...
final class Version20250207125542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Créer les tables de base d'abord (celles sans dépendances)
        ...
        // Ajouter les contraintes pour instructor et student
        ...
        // Créer la table course qui dépend de instructor
        ...
        // Ajouter les contraintes pour chapter et quiz
        ...
        // Ajouter les contraintes pour les relations
        ...
        // Créer les tables de communication
        ...
        // Ajouter les contraintes pour la communication
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FF624B39D FOREIGN KEY (sender_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FCD53EDB6 FOREIGN KEY (receiver_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CAA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');

        // Créer la table payment en dernier
        ...
        // Ajouter les contraintes pour payment
